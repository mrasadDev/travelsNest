  ...
  return (
    <div className="my-8">
      ...
      <div className="bg-gray-200 p-4 my-6 rounded-2xl flex items-center justify-between">
        ...
        <div className="bg-primary p-2 sm:p-6 text-white rounded-2xl">
          <div>Total price</div>
          <div className="text-xl sm: text-2xl">${booking.price}</div>
        </div>
      </div>
      <PlaceGallery place={booking.place} className="mb-16" />
    </div>
  );
}
